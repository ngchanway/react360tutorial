...
let pointerLockControls, position, raycaster;
// let orbitControls;
...
const pointSize = 3;
// raycasters
let upRaycaster, horizontalRaycaster, downRaycaster;
...
function animate() {
  ...
  if (pointerLockControls.isLocked) {
    ...
    raycaster.ray.origin.copy(control.position);
    ...
    // Check whether the control is hitting the model
    rotation.copy(pointerLockControls.getWorldDirection().multiply(new THREE.Vector3(-1, 0, -1)));
